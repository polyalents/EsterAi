...
class TextGenerationTab(QWidget):
    ...
    def __init__(self, argv):
        ...
        # Главное окно
        self.window = QWidget()
        self.window.setWindowTitle("EsterAI – Генерация текста")
        ...
        main_layout.addWidget(self.text_tab)
        ...
        # Подключаем сигналы
        self.text_tab.status_changed.connect(self.status_label.setText)
        self.text_tab.progress_changed.connect(self.progress.setValue)
